...
function FeedbackCard({
  ...
  return (
    <div className="flex flex-col items-center justify-between p-4 gap-4 rounded-br-3xl border-2 border-textColor1 h-full">
      <p className="text-textColor2 dark:text-black text-[18px] w-full text-left line-clamp-5">{feedback}</p>
