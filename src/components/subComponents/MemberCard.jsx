...
function MemberCard({
  ...
  return (
    <div className="flex flex-wrap-reverse justify-center items-center group h-full ">
      <div className="w-[80%] flex flex-col justify-center items-center border-2 border-textColor1 rounded-xl backdrop-blur-lg h-full dark:bg-[#ffccaa]">
        ...
        <div className="flex flex-col justify-start items-center h-[170px] mx-3 gap-3 mb-4">
          ...
          <div className="h-1/3 flex flex-col items-center justify-center">
            <p className="text-lg text-textColor2 dark:text-black font-medium">
          ...
          <div className="h-1/3 flex flex-row items-end justify-center gap-5">
            {github && (
              <a
                ...
                className="text-textColor2 dark:text-black hover:text-textColor1 hover:scale-105 duration-200 ease-in-out transition-all"
              >
