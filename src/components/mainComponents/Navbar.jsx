...
const Navbar = () => {
  ...
  return (
    <>
      <nav className="w-full py px-4 z-50 dark:bg-[#ffdab9] transparent sticky top-0 flex flex-row items-center justify-between backdrop-blur-3xl overflow-hidden  shadow-sm opacity-80">
