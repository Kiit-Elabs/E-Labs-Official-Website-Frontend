...
function Feedback() {
  ...
  return (
    <div className="flex flex-col items-center justify-around dark:bg-[radial-gradient(circle_at_center,#fff_1%,#ffedde_20%,#ffd4b3_50%)] pb-20 p-4 xl:px-8 w-full mt-24">
