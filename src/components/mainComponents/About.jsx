...
function About() {
  ...
  return (
    ...
    <div className="flex flex-wrap items-center justify-evenly mt-4 min-h-screen gap-8 mx-8 dark:bg-[radial-gradient(circle_at_center,#fff_1%,#ffedde_20%,#ffd4b3_50%)]">
      <Card />
      <HPCard
        heading="E Labs"
